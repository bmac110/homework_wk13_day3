...
public class WhiskyController {
    ...
    public List<Whisky> getWhiskyByDistilleryAndAge(@PathVariable Long id, @PathVariable int age){
        return whiskyRepository.findWhiskyByDistilleryAndAge(id, age);
    }

    @GetMapping(value = "region/{region}")
    public List<Whisky> getWhiskyByDistilleryAndRegion(@PathVariable String region){
        return whiskyRepository.findWhiskyByDistilleryAndRegion(region);
    }
}
